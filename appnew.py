...
def main():
    ...
    age = st.slider('Masukkan Umur', min_value=17, max_value=100, value=17)
    trestbps = st.slider("Tekanan Darah (restbp)", min_value=90, max_value=200, value=90)
    chol = st.slider("Kolestrol", 100, 600, 100)
    thalach = st.slider("Tekanan Darah Maksimal (thalach)", 100, 200, 100)
